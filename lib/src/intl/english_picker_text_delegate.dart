...
class EnglishPickerTextDelegate extends PickerTextDelegate {
  const EnglishPickerTextDelegate({
    ...
    super.sortMediaTitle = 'Sort Media',
    super.sortNewestFirst = 'Newest First',
    super.sortOldestFirst = 'Oldest First',
    super.sortLargestFirst = 'Largest First',
    super.sortSmallestFirst = 'Smallest First',
